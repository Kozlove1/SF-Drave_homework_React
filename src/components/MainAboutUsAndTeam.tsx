...
function MainAboutUs (props) {
    ...
    return(
        <>
          <div className="drawTeam"><Image className={"drawTeam__img"} src={"img/undraw_team.png"} alt={"Картинка команды"}/></div>
            <h1>О нас</h1>  
            ...
            <h3>Команда</h3>
              <section className="team">
                {teamMembers.map((members) => <Team_box name={members.name} proffesion={members.proffesion} photo={members.photo} alt={members.alt}/>)}
              </section>
        </>
    );
};
